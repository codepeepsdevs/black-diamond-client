...
const AddonImageInput: React.FC<{
  ...
  return (
    <div
      {...getRootProps()}
      className={cn(
        "event-details-file-input bg-[#757575] p-[20px] h-52 text-center cursor-pointer mt-5 flex justify-center items-center relative"
      )}
    >
      <input {...getInputProps()} />
...
export default AddonImageInput;
